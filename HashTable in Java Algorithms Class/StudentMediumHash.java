 ...
 * table.
 * 
 * @author Erin Parker and Divy Tripathy
 * @version 04/7/2022
 */
public class StudentMediumHash {
	...
	public int hashCode() {
		// try returning the first 3 digits of the uID
		String firstThreeUID = (this.uid + "").substring(0, 3);
		int hash = Integer.parseInt(firstThreeUID);
		return hash;
	}
}